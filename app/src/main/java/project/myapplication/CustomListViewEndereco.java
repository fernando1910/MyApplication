...
public class CustomListViewEndereco extends BaseAdapter{
    ...
    List<menuEndereco> items;
    Geocoder geocoder;
    Context context;

    public CustomListViewEndereco(Activity context, List<menuEndereco> items) {
        super();
        this.items = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final menuEndereco endereco = items.get(position);
    ...
    {
        menuEndereco item = items.get(postion);
